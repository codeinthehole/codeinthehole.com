...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cb_article', 'summary', self.gf('django.db.models.fields.TextField')(default='This is a summary'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.summary'
        db.delete_column('cb_article', 'summary')
